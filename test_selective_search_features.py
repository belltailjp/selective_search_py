...
class TestSelectiveSearchFeaturesBoundingBox:
    def setup_method(self, method):
        self.label_img = numpy.zeros((10, 10), dtype=int)

    def test_1region(self):
        bb = selective_search_features.bounding_box(self.label_img, 1)
        assert bb.shape == (1, 4)
    ...
    def test_4region(self):
        ...
        bb = selective_search_features.bounding_box(self.label_img, 4)
        assert bb.shape == (4, 4)
